...
ADMINS = (
      ('Dairon Medina', 'dairon@daganet.net'),
)
...
DATABASES = {
    'default': {
        ...
        'NAME': 'radios.db',                      # Or path to database file if using sqlite3.
        'USER': 'root',                      # Not used with sqlite3.
        'PASSWORD': 'daganet',                  # Not used with sqlite3.
...
SECRET_KEY = 'u-ox!yt#=ds)gz#skqn)nd85y0c)ll)-*n-#-j)@5zp6*0u6(^'
...
ROOT_URLCONF = 'anunciaenradios.urls'
